...
class IrAclientePage extends StatefulWidget {
  @override
  _MapaPageState createState() => _MapaPageState();
}

class _MapaPageState extends State<IrAclientePage> {
  @override
  void initState() {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned(top: 15, left: 10, child: SearchBar2()),
  ...
  Widget crearMapa(MiUbicacionState state) {
    ...
    print(state.ubicacion.latitude);
