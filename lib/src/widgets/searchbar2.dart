...
class SearchBar2 extends StatelessWidget {
  ...
  Widget buildSerchBar(BuildContext context) {
    ...
    if (categoryService.clienteLatitud == '') {
      return SafeArea(
          child: Container(
        ...
        child: RaisedButton.icon(
          ...
          label: Text('Revisa Info del Cliente'),
          onPressed: () {
    ...
    return SafeArea(
      ...
      child: RaisedButton.icon(
        ...
        label: Text('Mostrar a ruta cliente'),
        onPressed: () async {
